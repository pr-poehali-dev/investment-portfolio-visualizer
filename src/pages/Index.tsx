      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in">
          <Card className="hover-lift border-l-4 border-l-purple-500">
            ...
            <CardContent>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-sm text-green-600">+{formatCurrency(mockPortfolio.dailyChange)}</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover-lift border-l-4 border-l-blue-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{mockPortfolio.positions.length}</div>
              <div className="flex gap-2 mt-2">
                <Badge variant="outline" className="text-xs">
                  {mockPortfolio.positions.filter(p => p.type === 'stock').length} акций
                </Badge>
                <Badge variant="outline" className="text-xs">
                  {mockPortfolio.positions.filter(p => p.type === 'bond').length} облигаций
                </Badge>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover-lift border-l-4 border-l-pink-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{formatCurrency(mockPortfolio.yearlyDividends)}</div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="animate-scale-in">
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {mockPortfolio.dividends.slice(0, 3).map((div, idx) => (
          ...
          <TabsContent value="portfolio" className="space-y-6">
            <Card className="animate-fade-in">
              ...
              <CardContent>
                <div className="space-y-4">
                  {mockPortfolio.positions.map((position, idx) => (
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="animate-fade-in">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {mockPortfolio.dividends.map((div, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 rounded-lg border hover-lift">
                        <div className="flex items-center gap-3">
              ...
              <Card className="animate-fade-in">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {mockPortfolio.positions.slice(0, 5).map((position, idx) => {
